        ...
        <div className="main-page">
            <nav className="navbar glass-effect">
                <div className="logo-container">
                    ...
                    <div className="logo-text">✈️ AeroVista</div>
                </div>
            ...
            <section className="discounts-section">
                ...
                <div className="slideshow-container">
                    ...
                    <div className="slide fade">
                        ...
                        <div className="caption">🧳 Weekend Getaways Starting at ₹2,999</div>
                    </div>
                </div>
            </section>

            <footer className="footer">
                <p>📞 +91-9876543210 | 📧 support@aerovista.com</p>
                <p>© 2025 AeroVista Airlines. All rights reserved.</p>
            </footer>
        </div>
    );
};
